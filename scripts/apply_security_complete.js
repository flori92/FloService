/**
 * Script principal pour appliquer les politiques de sécurité RLS
 * Ce script coordonne l'exécution des deux parties du script de sécurité
 */

import { applySecurityPoliciesPart2 } from './apply_security_final_v2_part2.js';
import pg from 'pg';
...
async function applySecurityPolicies() {
  ...
  try {
    ...
    // Exécuter la partie 2 du script
