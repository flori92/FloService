...
async function applySecurityPolicies() {
  ...
  try {
    ...
    // 7. Création d'un script SQL pour référence future
...
`;
    ...
    console.log('Script SQL de référence créé et sauvegardé dans la table security_scripts');
    ...
    console.log('Un script SQL de référence a été sauvegardé dans la table security_scripts');
