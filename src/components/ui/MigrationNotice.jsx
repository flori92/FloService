...
/**
 * Composant pour afficher une notification concernant les migrations de base de données manquantes
 * @param {Object} props - Propriétés du composant
 * @param {Function} props.onClose - Fonction appelée lors de la fermeture de la notification
 * @param {string} props.className - Classes CSS additionnelles
 */
const MigrationNotice = ({ onClose, className = '' }) => {
  return (
    <div className={`fixed bottom-20 right-6 w-80 bg-white rounded-lg shadow-lg border border-amber-300 p-4 z-50 ${className}`}>
