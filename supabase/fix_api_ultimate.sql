...
-- Corriger/Créer is_provider sur profiles
DO $$
BEGIN
  ...
  ELSE
    -- Si elle existe, s'assurer qu'elle est du bon type
    ALTER TABLE public.profiles ALTER COLUMN is_provider TYPE BOOLEAN USING is_provider::BOOLEAN;
  ...
  CREATE POLICY "Modification uniquement par le propriétaire" ON public.profiles 
    FOR UPDATE USING (auth.uid() = id);
    
  CREATE POLICY "Insertion uniquement par le propriétaire" ON public.profiles 
